...
- (NSArray *)yy_map:(id  _Nullable (^)(id _Nonnull, NSUInteger))block {
...
- (void)yy_each:(void (^)(id _Nonnull, NSUInteger))block {
    NSParameterAssert(block != nil);
...
- (id)yy_match:(BOOL (^)(id _Nonnull))block {
    NSParameterAssert(block != nil);
...
- (NSUInteger)yy_filter:(BOOL (^)(id))block {
    NSParameterAssert(block != nil);
